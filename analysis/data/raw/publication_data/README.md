...
This directory contains the raw data underlying the manuscript figures and analyses, as required by Current Biology's data availability policy.
...
> [Author list]. ([Year]). [Manuscript title]. *Current Biology*. DOI: [to be assigned]
